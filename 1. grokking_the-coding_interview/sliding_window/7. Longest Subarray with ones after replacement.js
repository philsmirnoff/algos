...
function length_of_longest_substring(arr, k) {
  ...
  for (windowEnd = 0; windowEnd < arr.length; windowEnd++) {
    ...
    // Current window size is from windowStart to windowEnd, overall we have a maximum of
    // 'maxOnesCount' 1s, this means we can have a window with 'maxOnesCount' 1s and the remaining
    // 0s we should replace.
